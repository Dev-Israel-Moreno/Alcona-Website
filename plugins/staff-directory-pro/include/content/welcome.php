...
<p class="aloha_intro"><strong>Thank you for installing Company Directory!</strong> This page is here to help you get up and running. If you're already familiar with Company Directory, you can skip it and <a href="<?php echo $settings_url; ?>">continue to the Basic Settings page</a>.</p>
...
<br>
<a href="<?php echo $new_post_link; ?>" class="button">Create A New Staff Member &raquo;</a></p>
<br>
...
<p> For more information on displaying your staff members, please <a href="https://goldplugins.com/documentation/company-directory-documentation/company-directory-instructions/<?php echo $utm_str; ?>#outputting_staff_members">see our documentation</a>.</p>
<br>
<a href="#getting_started">Back To Top</a>
<br>
<br>
...
<h4>Further Reading</h4>
<p> For more information on Company Directory, please <a href="https://goldplugins.com/documentation/company-directory-documentation/<?php echo $utm_str; ?>">see our documentation</a>.</p>
<br>
<a href="#getting_started">Back To Top</a>
<br>
<br>
...
<div class="three_col">
	...
	<div class="col">
		...
		<ul>
			<li><a href="<?php echo $new_post_link; ?>">Click Here To Add Your First Staff Member</a></li>
			<li><a href="https://goldplugins.com/documentation/company-directory-documentation/company-directory-instructions/<?php echo $utm_str; ?>">Getting Started With Company Directory</a></li>
			<li><a href="https://goldplugins.com/documentation/company-directory-documentation/company-directory-pro-examples/<?php echo $utm_str; ?>"><?php echo $plugin_title; ?> Examples</a></li>
			<li><a href="https://goldplugins.com/documentation/company-directory-documentation/company-directory-faqs/<?php echo $utm_str; ?>">Frequently Asked Questions (FAQs)</a></li>
	...
	<div class="col">
		...
		<ul>
			<li><a href="https://goldplugins.com/documentation/company-directory-documentation/<?php echo $utm_str; ?>">Company Directory Documentation</a></li>
			<li><a href="https://wordpress.org/support/plugin/staff-directory-pro/<?php echo $utm_str; ?>">WordPress Support Forum</a></li>
			<li><a href="https://goldplugins.com/documentation/company-directory-documentation/company-directory-pro-changelog/<?php echo $utm_str; ?>">Recent Changes</a></li>
