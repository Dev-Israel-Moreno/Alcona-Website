...
class StaffDirectoryPlugin_SettingsPage
{
    ...
    {		
		...
		$tabs_list[] = array(
			...
			'label' => 'Privacy Options', // section label
	...
	function custom_fields_upgrade_page() 
	{
		...
		echo '</div>';
		echo '</div>';
		echo $this->custom_fields_demo_modal();
		...
		<div class="company_directory_demo_modal">
			<div class="company_directory_demo_modal_top">
				...
				<ul class="company_directory_feature_list company_directory_feature_list_left">
					<li><?php echo $this->check_icon(); ?> Supports unlimited fields</li>
					<li><?php echo $this->check_icon(); ?> Drag-and-drop interface</li>
					<li><?php echo $this->check_icon(); ?> Works with Import/Export</li>
					<li><?php echo $this->check_icon(); ?> Works with Advanced Search</li>
					<li><?php echo $this->check_icon(); ?> Available in Custom Templates</li>					
					<li><?php echo $this->check_icon(); ?> Won't affect existing data</li>
				</ul>
				<ul class="company_directory_feature_list company_directory_feature_list_right">
					<li><?php echo $this->check_icon(); ?> Text Fields</li>					
					<li><?php echo $this->check_icon(); ?> Checkboxes</li>					
					<li><?php echo $this->check_icon(); ?> Radio Buttons</li>					
					<li><?php echo $this->check_icon(); ?> Dropdown Menus</li>					
					<li><?php echo $this->check_icon(); ?> Multiple Choice Fields</li>					
					<li><?php echo $this->check_icon(); ?> Email / Phone / Date Fields</li>					
				</ul>
				<div style="clear:both"></div>
			</div>
			<div class="company_directory_demo_modal_bottom">
				<a class="company_directory_btn" href="<?php echo $this->get_upgrade_url('placeholders', 'custom_fields'); ?>" target="_blank">Upgrade To Company Directory Pro Now</a>
	...
	function import_export_demo_modal()
	{
		...
		<div class="company_directory_demo_modal">
			<div class="company_directory_demo_modal_top">
				...
				<!--<p></p>-->
				<ul class="company_directory_feature_list company_directory_feature_list_left">
					<li><?php echo $this->check_icon(); ?> Import from 200+ file types</li>
					<li><?php echo $this->check_icon(); ?> Import from CSV &amp; Excel files</li>
					<li><?php echo $this->check_icon(); ?> Import from LDAP servers</li>
					<li><?php echo $this->check_icon(); ?> Import from Active Directory</li>
				</ul>
				<ul class="company_directory_feature_list company_directory_feature_list_right">
					<li><?php echo $this->check_icon(); ?> Easy-To-Use Import Wizard</li>
					<li><?php echo $this->check_icon(); ?> Scheduled Imports</li>
					<li><?php echo $this->check_icon(); ?> Column Mapping</li>
					<li><?php echo $this->check_icon(); ?> Background Processing</li>
				</ul>
				<div style="clear:both"></div>
			</div>
			<div class="company_directory_demo_modal_bottom">
				<a class="company_directory_btn" href="<?php echo $this->get_upgrade_url('placeholders', 'import_export'); ?>" target="_blank">Upgrade To Company Directory Pro Now</a>
    ...
    {
		echo '<p>Use these options to enable or disable private mode.</p>';
    }
...
?>
		...
		<div id="company_directory_notice_bar">
			<span class="company_directory_notice_bar_message"><?php _e("You're using the free version of"); ?> Company Directory. <?php _e('To unlock more features consider'); ?> <a href="<?php echo $this->get_upgrade_url('reminders', 'adminbar'); ?>" target="_blank" rel="noopener noreferrer"><?php _e('upgrading to Pro'); ?></a>.</span>
