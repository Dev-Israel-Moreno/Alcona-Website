	...
	<div class="tg-blog-widget <?php echo esc_attr( $col ); ?>">
		...
		<div class="post-image <?php echo esc_attr( $post_image ); ?>">
			...
			<!-- <span class="entry-date">
				<i class="fa fa-clock-o">III</i><a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark"><?php echo esc_html ( get_the_date() ); ?></a>
			</span> -->
			<?php } ?>
		</div>
		<div class="blog-content">
			<span class="entry-date">
				<i class=""></i><a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark"><?php echo esc_html ( get_the_date() ); ?></a>
			</span>
			<h3 class="entry-title"><a href="<?php echo esc_url( get_permalink() ); ?>"><?php echo esc_html( get_the_title() ); ?><div class="arrow"></div></a></h3>
