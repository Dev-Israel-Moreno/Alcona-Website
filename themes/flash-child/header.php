...
<link rel="stylesheet" href="https://use.typekit.net/ptx1fqt.css">
...
<div id="page" class="site">
	...
	<?php if( !is_front_page() and !is_single() and !is_search() and !is_category() and !is_archive()) : ?>
		<?php	if ( has_post_thumbnail() ) { the_post_thumbnail(); } ?>
	<nav id="thumbnail-breadcrumbs" class="breadcrumb-trail breadcrumbs thumbnail">
		<div class="tg-container">
	...
	<?php endif; ?>
	<?php if( is_single() and in_category(array(1,7)) ) : ?>
	
	<nav id="products-breadcrumbs products" class="breadcrumb-trail products thumbnail">
		<div class="tg-container ">
		    <?php the_category(', ');  ?>
			<?php flash_page_title(); ?>
			<?php the_excerpt(); ?>
	...
	<?php endif; ?>
	<?php if(( is_single() and  !in_category(array(1,7)) ) or is_search() or is_category() or is_archive()) : ?>		
